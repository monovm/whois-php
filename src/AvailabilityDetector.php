...
class AvailabilityDetector
{
    ...
    private static function containsUnavailabilityIndicators(string $whoisMessage, string $tld = ''): bool
    {
        ...
        $tldUnavailabilityPatterns = [
            ...
            '.de' => ['/status:\s*connect/i', '/status:\s*registered/i', '/status:\s*active/i', '/status:\s*redemptionPeriod/i', '/status:\s*redemption/i'],
        ...
        $generalUnavailabilityPatterns = [
            ...
            '/status:\s*active/i',
            '/status:\s*client/i',
            '/status:\s*redemptionPeriod/i',
            '/status:\s*redemption\s*period/i',
            '/status:\s*redemption/i',
            '/status:\s*pendingDelete/i',
            '/status:\s*pending\s*delete/i',
            '/status:\s*serverHold/i',
            '/status:\s*server\s*hold/i',
